    ...
    export default {
        data: function () {
            return{
                ...
                wallTiles: wallTiles,
                unclickableTiles: ['BaseTile', 'WaterTile', 'WaterCornerTile', 'WallLeft', 'WallLeftEnd', 'WallRight', 'WallRightEnd', 'NatureForest_1', 'NatureForest_2']
            }
        },
        computed: {
            village: function(){
        ...
        methods: {
            ...
            buildBuildingTiles: function(village){
                let buildingList = village.buildings;
