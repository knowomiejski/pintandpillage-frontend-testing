...
<style lang="scss" scoped>
    @-webkit-keyframes blinking {
        from {filter: drop-shadow(0px 0px 12px rgb(247, 156, 0));
        }
        to {filter: none;
        }
    }
    ...
    .buttonDiv{
        ...
        margin-right: 1%;
        .mapButton, .settingsButton, .villageButton, .questButton, .questBlinking, .combatButtonHeader{
            width: 90px;
            height: 70px;
            margin-left: 12px;
            margin-top: 30px;
        ...
        .gameLogsButton, .gameLogsButtonBlink{
            width: 190px;
            height: 210px;
            display: flex;
            flex-direction: row;
        ...
        .gameLogsButtonWinter, .gameLogsButtonBlinkWinter{
            width: 190px;
            height: 210px;
            display: flex;
            flex-direction: row;
        ...
        .gameLogsButtonBlink, .gameLogsButtonBlinkWinter{
            -webkit-animation-name: blinking;
            -webkit-animation-duration: 0.8s;
            -webkit-animation-iteration-count:infinite;
            -webkit-animation-timing-function:ease-in-out;
        ...
        .mapButton:hover, .settingsButton:hover, .gameLogsButton:hover, .gameLogsButtonWinter:hover, .questButton:hover, .questBlinking:hover , .combatButtonHeader:hover{
            opacity: 1 !important;
            background-size: 90px 80px;
            height: 80px;
            width: 90px;
        }
        .gameLogsButton:hover, .gameLogsButtonBlink:hover{
            opacity: 1 !important;
        ...
        .gameLogsButtonWinter:hover, .gameLogsButtonBlinkWinter:hover{
            opacity: 1 !important;
            background-size: 190px 210px;
            width: 190px;
            height: 210px;
