...
<!--          TODO: notInProgress id added for testing-->
            <div id="notInProgress" class="notInProgress" v-if="!currentBuilding.isUnderConstruction">
...
<!--          TODO: underConstruction id added for testing-->
            <div id="underConstruction" v-else class="underConstruction">
